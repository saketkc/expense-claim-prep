...
2. Both scripts run standalone with any Python + [`pymupdf`](https://pypi.org/project/PyMuPDF/) — no Claude Code required:
   ```bash
   pip install pymupdf
   ...
   ```
3. The Gmail-search and screenshot step assumes some form of browser automation is available to the agent; without it, just skip that step and find the alert emails yourself.
